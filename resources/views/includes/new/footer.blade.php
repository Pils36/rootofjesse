                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12 footer-widget">
                            ...
                            <ul class="address-widget">
                                <li>
                                    ...
                                    <div class="desc">2b Degema close, Rumuibekwe Port Harcourt, Nigeria</div>
                                </li>
                                <li>
                                    <i class="flaticon-call"></i>
                                    <div class="desc">
                                        <a href="tel:08033104890">080-331-048-90</a>
                                    </div>
                                </li>
                                <li>
                                    <i class="flaticon-email"></i>
                                    <div class="desc">
                                        <a href="mailto:info@therootofjessephc.com">info@therootofjessephc.com</a> , 
                                        <a href="{{ route('home') }}">www.rootofjessephc.com</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="row y-middle">
                        ...
                        <div class="col-lg-4 md-mb-20">
                            <div class="copyright text-center md-text-left">
                                <p>&copy; {{ date('Y') }} The Root of Jesse Church, PHC</a></p>
                            </div>
                        </div>
                        <div class="col-lg-4 text-right md-text-left">
                            <ul class="footer-social">
                                <li><a href="https://www.facebook.com/TheRootofJesse/" target="_blank"><i class="fa fa-facebook"></i></a></li>
                                {{-- <li><a href="#"><i class="fa fa-twitter"></i></a></li> --}}
                                <li><a href="https://instagram.com/rootofjesse_phc" target="_blank"><i class="fa fa-instagram"></i></a></li>
