...
<head>
    ...
    <meta name="description" content="Our Sunday service is designed to speak to you, right where you are. With a friendly atmosphere, contemporary worship, live WORD and multimedia we seek to express relevant and meaningful truth to all who attend.">
        ...
        <!-- font-awesome css -->
        <link rel="stylesheet" type="text/css" href="{{ asset('new/assets/css/font-awesome.min.css') }}">
        <!-- animate css -->
        ...
        <!-- linea-font css -->
        <link rel="stylesheet" type="text/css" href="{{ asset('new/assets/fonts/linea-fonts.css') }}">
        <!-- flaticon css  -->
        <link rel="stylesheet" type="text/css" href="{{ asset('new/assets/fonts/flaticon.css') }}">
        <!-- magnific popup css -->
        <link rel="stylesheet" type="text/css" href="{{ asset('new/assets/css/magnific-popup.css') }}">
        <!-- Main Menu css -->
        <link rel="stylesheet" href="{{ asset('new/assets/css/rsmenu-main.css') }}">
        <!-- spacing css -->
