        ...
        <div class="nk-block nk-block-lg">
            ...
            <div class="card card-bordered">
                <div class="card-inner">
                    ...
                    <form action="{{ route('edit this category', $data['messageCategory']->id) }}" class="gy-3" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-lg-8">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <input type="text" name="name" class="form-control" id="name" value="{{ $data['messageCategory']->name }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
